...
public class BossSpider extends EventBase
{
	private Location _loc;

	public BossSpider(EventManager manager) 
	{
		super(manager, "Brood Mother", 1); 
	}
	...
	private void FindLocation() 
	{
		...
		if (_loc != null)
		{
			...
			CreatureRegister(new BroodMother(this, loc.add(0.5, 0.5, 0.5)));
		}
	}
