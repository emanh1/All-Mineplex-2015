...
public class BossSkeleton extends EventBase
{
	private Location _loc;

	public BossSkeleton(EventManager manager) 
	{
		super(manager, "Skeleton King", 1); 
	}
	...
	private void FindLocation() 
	{
		...
		if (_loc != null)
		{
			...
			CreatureRegister(new SkeletonKing(this, loc.add(0.5, 0.5, 0.5)));
		}
	}
	...
	public void AnnounceDuring() 
	{
		for (EventMob cur : GetCreatures())
			if (cur instanceof SkeletonKing)
