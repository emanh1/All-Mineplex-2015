...
public class BossSwarmer extends EventBase
{
	private Location _loc;

	public BossSwarmer(EventManager manager) 
	{
		super(manager, "Swarmer", 1); 
	}
	...
	private void FindLocation() 
	{
		...
		if (_loc != null)
		{
			...
			CreatureRegister(new SwarmerHost(this, loc.add(0.5, 0.5, 0.5)));
		}
	}
	...
	{
		UtilServer.broadcast(F.main("World Event", F.elem("Swarmer") + " has entered the world."));	
	...
	{
		UtilServer.broadcast(F.main("World Event", F.elem("Swarmer") + " has been defeated!"));
	...
	{
		UtilServer.broadcast(F.main("World Event", F.elem("Swarmer") + " has left the world."));		
